...
func seedData(t *testing.T, c context.Context, db *pgxpool.Pool) (*customer.Customer, *customer.Session) {
	optionID := uuid.New()
	...
	cstmr, _ := customer.NewCustomer("user2@example.com", "12346578", "John Doe", subscription)
